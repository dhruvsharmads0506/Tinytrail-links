...
const LandingPage = () => {
  ...
  The only URL Shortener <br /> you’ll ever need! 👇
      ...
      <form onSubmit={handleShorten} className='sm:h-14 flex flex-row w-full md:w-2/4 gap-2' >
        <Input type="url" placeholder='Enter your looooong URL' onChange={(e)=>setLongUrl(e.target.value)} className='h-full flex-1 py-4 px-4'/>
  ...
  <AccordionItem value="item-2">
    <AccordionTrigger>Do I need an account to use the app?
</AccordionTrigger>
    <AccordionContent>
